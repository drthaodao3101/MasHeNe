...
class ACSNet(nn.Module):
    def __init__(self, num_classes):
        ...
        # Sideout
        self.sideout2 = SideoutBlock(64, num_classes)
        self.sideout3 = SideoutBlock(128, num_classes)
        self.sideout4 = SideoutBlock(256, num_classes)
        self.sideout5 = SideoutBlock(512, num_classes)
