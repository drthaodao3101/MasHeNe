...
CKPT_PATH='/home/dtpthao/ntcong_tai/Swin-UMamba_Seg_VoFo/pre_trained_weights/vmamba_tiny_e292.pth'  #'/home/dtpthao/khoi/vofoseg/weights/swinumamba_99.pth'
    ...
    def forward(self, x_in):
        ...
        if self.out_chans == 1: 
            if isinstance(out, list):
                return [torch.sigmoid(o) for o in out]
            else:
                return torch.sigmoid(out)
        else:
            #if isinstance(out, list):
            #    return [torch.softmax(o, dim=1) for o in out]
            #else:
...
def get_swin_umamba(
    ...
    model = SwinUMamba(
        ...
        out_chans=num_segmentation_heads,
        feat_size=[48, 96, 192, 384, 768],
